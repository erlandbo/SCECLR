...
def initialize_logger(args):
    ...
    exppath = os.path.join(args.mainpath, "logs/"+current_time + f"_{args.basedataset}_{args.criterion}_{args.metric}_batch{args.batchsize}_feature{args.outfeatures}/")
